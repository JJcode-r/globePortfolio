...
const coreItems: TechItem[] = [
  {
    ...
    description: 'Declarative UIs that feel alive  built with React 19.',
    brandColor: '#61DAFB',
  },
  {
    id: 2,
    ...
    description:
      'Strongly typed. Safe. Scalable. TypeScript is my second language.',
    brandColor: '#3178C6',
  },
  {
    id: 3,
    ...
    description: 'Cinematic animations that flow with intent and precision.',
    brandColor: '#E44CFF',
  },
  {
    id: 4,
    ...
    description: 'Clean, responsive interfaces  built at the speed of thought.',
    brandColor: '#38BDF8',
  },
  {
    id: 5,
    ...
    description: 'Blazing-fast apps powered by the Next.js ecosystem.',
    brandColor: '#FFFFFF',
  },
  {
    id: 6,
    name: 'Ethers / Web3',
    logo: 'https://raw.githubusercontent.com/ethers-io/ethers.js/master/docs/logo.svg',
    description: 'Connecting user experiences to decentralized worlds.',
    brandColor: '#627EEA',
  },
  {
    id: 7,
    ...
    description: 'The backbone of the web  clean, optimized, and expressive.',
    brandColor: '#F7DF1E',
  },
  {
    id: 8,
    ...
    description: 'Structure and semantics that stand the test of time.',
    brandColor: '#E34F26',
  },
  {
    id: 9,
    ...
    description: 'Modern layouts with depth, motion, and personality.',
    brandColor: '#2965F1',
  },
...
const paymentsItems: TechItem[] = [
  {
    ...
    description:
      'Full payment flows, webhooks, and retry logic  built to actually collect money.',
    brandColor: '#00C3F7',
  },
  {
    id: 22,
    name: 'Flutterwave',
    logo: 'https://cdn.simpleicons.org/flutterwave',
    description:
      'Multi-method payment integration across African and global markets.',
    brandColor: '#F5A623',
  },
  {
    id: 23,
    ...
    description:
      'Reliable billing, subscriptions, and one-time payments for global platforms.',
    brandColor: '#635BFF',
  },
  {
    id: 24,
    ...
    description: 'Edge-first serverless runtime  fast, global, and always on.',
    brandColor: '#F48120',
  },
  {
    id: 25,
    name: 'Hono',
    logo: 'https://cdn.simpleicons.org/hono',
    description: 'Ultrafast web framework built for edge runtimes and APIs.',
    brandColor: '#E36002',
  },
  {
    id: 26,
    ...
    description:
      'Type-safe SQL with zero runtime overhead  the ORM that stays out of your way.',
    brandColor: '#C5F74F',
  },
  {
    id: 27,
    ...
    description:
      'Battle-tested relational database for complex, production-grade data models.',
    brandColor: '#336791',
  },
  {
    id: 28,
    ...
    logo: 'https://www.vectorlogo.zone/logos/cloudflare/cloudflare-icon.svg',
    description:
      "Cloudflare's edge-native SQL database  low-latency, globally distributed.",
    brandColor: '#F48120',
  },
  {
    id: 29,
    ...
    logo: 'https://cdn.worldvectorlogo.com/logos/nextjs-2.svg',
    description:
      'Full-stack React framework powering fast, production-ready applications.',
    brandColor: '#FFFFFF',
  },
  {
    id: 30,
    ...
    logo: 'https://raw.githubusercontent.com/devicons/devicon/master/icons/typescript/typescript-original.svg',
    description:
      'End-to-end type safety  catches the bugs that cost you money in production.',
    brandColor: '#3178C6',
  },
];
...
const secondaryItems: TechItem[] = [
  {
    ...
    description: 'Scalable backends, simplified.',
    brandColor: '#FFCA28',
  },
  {
    id: 12,
    name: 'Cypress',
    logo: 'https://cdn.worldvectorlogo.com/logos/cypress-io-1.svg',
    description: 'End-to-end testing that never misses a beat.',
    brandColor: '#69D3A7',
  },
  {
    id: 13,
    ...
    description: 'Confidence through automated testing.',
    brandColor: '#99425B',
  },
  {
    id: 14,
    ...
    description: 'Deployments so seamless, they feel instant.',
    brandColor: '#FFFFFF',
  },
  {
    id: 15,
    ...
    description: 'Version control that fuels collaboration.',
    brandColor: '#F5F5F5',
  },
  {
    id: 16,
    ...
    description: 'Turning design systems into living components.',
    brandColor: '#A259FF',
  },
  {
    id: 17,
    name: 'Redux Toolkit',
    logo: 'https://raw.githubusercontent.com/reduxjs/redux/master/logo/logo.svg',
    description: 'Clean, structured state management that scales.',
    brandColor: '#764ABC',
  },
  {
    id: 18,
    ...
    description: 'Consistency and clarity across every line of code.',
    brandColor: '#4B32C3',
  },
...
// --- Component ---
export const InfiniteTechGrid: React.FC<{ data?: StackDataRow[] }> = ({
  data = STACK_DATA_ROWS,
}) => {
  ...
  const [tooltipSide, setTooltipSide] = useState<'left' | 'right' | 'center'>(
    'center'
  );
  ...
  return (
    <section
      id="tech"
      className="relative w-full overflow-hidden min-h-[50vh] flex flex-col justify-center py-16 bg-transparent backdrop-blur-md border-y border-white/10"
    >
      {/* Heading */}
      <motion.div
        ref={headingRef}
      ...
      {data.map((row, rowIndex) => (
        <div key={row.id} className="relative flex overflow-hidden my-2">
          <motion.div
            ref={(el) => {
              rowMotionRefs.current[rowIndex] = el;
            }}
            className="flex"
            animate="animate"
          ...
          >
            {row.items.map((tech, techIndex) => (
              <motion.div
                ...
                whileHover={{
                  scale: 1.05,
                  boxShadow: `0 0 25px ${tech.brandColor || 'rgba(255,255,255,0.25)'}`,
                }}
              ...
              >
                {!tech.empty && (
                  <img
                    src={tech.logo}
                    alt={tech.name}
                    className="h-full max-h-14 sm:max-h-16 object-contain brightness-110 contrast-125"
                  />
                )}
              </motion.div>
            ))}
        ...
        {hoveredTech && hoverPosition && (
          <motion.div
            ...
            style={{
              ...
              left:
                tooltipSide === 'left'
                  ? Math.max(hoverPosition.x, 120)
                  : tooltipSide === 'right'
                    ? Math.min(hoverPosition.x, window.innerWidth - 120)
                    : hoverPosition.x,
              top: hoverPosition.y,
          ...
          >
            <div className="flex items-center gap-2 mb-1">
              ...
              <span
                ...
                style={{ color: hoveredTech.brandColor || '#FFD66B' }}
              >
                {hoveredTech.name}
              </span>
            </div>
            ...
            <div
              className="absolute left-1/2 bottom-[-10px] w-0 h-0"
              style={{
                transform: 'translateX(-50%)',
